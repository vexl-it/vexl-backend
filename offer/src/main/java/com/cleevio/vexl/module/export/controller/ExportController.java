...
public class ExportController {
    ...
    PdfExportResponse exportMyData(@RequestHeader(SecurityFilter.HEADER_PUBLIC_KEY) String publicKey) {
        return new PdfExportResponse(exportService.exportMyData(publicKey));
    }
}
